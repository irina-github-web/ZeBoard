...
$.getJSON("https://video.gd.ru/event-type-2", function (data) {
  ...
  $.each(data, function (i, item) {
    ...
    $.each(item.videos, (iVideoId, aVideo) => {
      result_preview.push(
        `<div class="preview_tooltip">${aVideo.video_name}</div>` +
        `<div class="video_preview preview_vebinar3_1 liteTooltip" style="background-image: url(../images/icn_play_small.png), url(${aVideo.video_pic_url});" data-tooltip="${aVideo.video_name}"></div>`
      );
    });
